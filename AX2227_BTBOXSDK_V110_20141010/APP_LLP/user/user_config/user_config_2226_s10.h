 ...
 * Author    : jingfa
 * Email     :
 * Function  : 用户 USER_2226_S10 自定义参数设置
 *****************************************************************************/
...
#define MP3BT_DECT_REUSE_EN             1   //开机检测MP3和BT的IO是否复用其他IO(主要用于2226复用P05作MP3BT开机检测)
...
#define LED_USE_USBIO                   1   //是否使用USBDP/USBDM推LED灯(主要用于2226 IO 口不够用时)(打开后不能使用U盘和USBDEV)
