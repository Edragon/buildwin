...
extern char lcd_buf1[];
extern char lcd_buf2[];
extern char lcd_buf3[];
extern char lcd_buf4[];
extern char *lcd_buf;
#else
...
void dispmem_update(u8 lcd_width, u8 lcd_height, char *line_buf, u8 len);
u8 dispmem_draw(void *ptr, u8 x, u8 line);
