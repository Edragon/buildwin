...
#define TASK_MENU_EN                    1   //是否打开主菜单功能。一般应用于LCD点阵屏
#define TASK_MUSIC_EN                   1   //是否打开MUSIC功能
#define TASK_AUX_EN                     1   //是否打开AUX功能
#define TASK_AUX_EQ_EN                  1   //是否打开AUX EQ功能
...
#define TASK_SHOWTIME_EN                1   //是否打开时间显示功能
#define TASK_SETTING_EN                 1   //是否打开系统设置功能
...
#define THEME_SELECT                    THEME_LCD_DEFAULT
...
#define MUSIC_LRC_EN                    1   //是否需要MP3歌词显示
...
#define FM_VOUT_THROUGH_MCU             1               //FM VOUT是否通过主控
#define FM_CLK_SEL                      P33_OUT_NULL    //FM时钟选则
#define FM_TIME_EN                      0               //定时收听电台
#define FM_SET_VOL_CHANGE_BANK          1               //FM设置音量是否切bank
#define FM_RECORD_EN                    1               //是否打开FM录音功能
...
#define FM_CHANNEL_SEL                  CHANNEL_20_21       //定制FM的通道
...
#define BT_PHONE_BOOK_EN                1     //是否支持电话本功能
...
//LDO MODE下的PMU配置
#define USER_OTHER_INIT()               lqfp48_pmu_init()
...
#define LCD_CS          2   //P22
#define LCD_A0          3   //P23
#define LCD_BACKLIGHT   7   //p17
#define LCD_RES         6   //p16
#endif

#ifndef LCD_BACKLIGHT_SET
#define LCD_BACKLIGHT_SET
#define LCD_BACKLIGHT_ON()          if (!sys_ctl.backlight_sta) {\
                                    sys_ctl.backlight_sta = 1;\
                                    P1DIR &= ~(1<<LCD_BACKLIGHT);\
                                    P1PU &= (1<<LCD_BACKLIGHT);\
                                    P1 |= (1<<LCD_BACKLIGHT);}
#define LCD_BACKLIGHT_OFF()         if (sys_ctl.backlight_sta) {\
                                    sys_ctl.backlight_sta = 0;\
                                    P1DIR &= ~(1<<LCD_BACKLIGHT);\
                                    P1 &= ~(1<<LCD_BACKLIGHT);}
#endif

#ifndef LCD_PORT_SET
#define PORT_INIT()                 PMUXCON0 |= BIT(4);\
                                    P2DIR &= ~((1<<LCD_CLK) |(1<<LCD_DATA));\
                                    P2DIR &= ~ ((1<<LCD_CS) | (1<<LCD_A0) );\
                                    //P1DIR &= ~ (1<<LCD_RES);\
                                    P2 |=  ( (1<<LCD_CLK) |(1<<LCD_DATA) )

#define SET_LCD_A0                  P2 |=  (1<<LCD_A0)
#define CLR_LCD_A0                  P2 &= ~(1<<LCD_A0)

#define SET_LCD_CS                  P2 |=  (1<<LCD_CS)
#define CLR_LCD_CS                  P2 &= ~(1<<LCD_CS)

#define SET_LCD_RES                 //P1 |=  (1<<LCD_RES)
#define CLR_LCD_RES                 //P1 &= ~(1<<LCD_RES)
...
#define SYSTEM_TIME_SET                 1           //闹钟和时间设置，1：闹钟和时间设置在系统设置下 0：闹钟和时间设置在日历模式下
 ...
 *****************************************************************************/
#define CHARACTER_CONVERT                0x01               // 使用字库转换表
#define CHARACTER                        0x01               // 使用字库
#define PICTURE                          0x01               // 使用图片资源
#define MENU_PICTURE                     0x01               // 使用菜单图片资源
